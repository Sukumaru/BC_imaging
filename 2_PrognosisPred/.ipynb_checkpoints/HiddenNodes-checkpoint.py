...
def features_hidden(file_name,data):
    ...
    #numpy.savetxt("ht_259p_phenotypic27.csv", Out_h, delimiter=",")
    #numpy.savetxt("ht_259p_micro273.csv", Out_h, delimiter=",")
    numpy.savetxt("ht_259p_tumor105.csv", Out_h, delimiter=",")
